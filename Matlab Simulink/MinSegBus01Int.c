 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Sat Jan 24 16:02:34 2015
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME MinSegBus01Int
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void MinSegBus01Int_Outputs_wrapper(const int16_T *uint16_01,
			const real_T *xD,
			const int8_T  *Address, const int_T  p_width0);
extern void MinSegBus01Int_Update_wrapper(const int16_T *uint16_01,
			real_T *xD,
			const int8_T  *Address,  const int_T  p_width0);
