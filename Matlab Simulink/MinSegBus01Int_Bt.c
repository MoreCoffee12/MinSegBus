 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Sat Feb 21 17:14:05 2015
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME MinSegBus01Int_Bt
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          1
/* Input Port  0 */
#define IN_PORT_0_NAME      uint16_01
...
extern void MinSegBus01Int_Bt_Outputs_wrapper(const int16_T *uint16_01,
			const real_T *xD,
			const int8_T  *Address, const int_T  p_width0);
extern void MinSegBus01Int_Bt_Update_wrapper(const int16_T *uint16_01,
			real_T *xD,
			const int8_T  *Address,  const int_T  p_width0);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    MinSegBus01Int_Bt_Outputs_wrapper(uint16_01, xD, Address, p_width0);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    MinSegBus01Int_Bt_Update_wrapper(uint16_01,  xD, Address, p_width0);
}
