 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Sun Mar  8 10:22:07 2015
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME MinSegBus08Float_BT
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          8
/* Input Port  0 */
#define IN_PORT_0_NAME      float_01
...
/* Input Port  1 */
#define IN_PORT_1_NAME      float_02
...
/* Input Port  2 */
#define IN_PORT_2_NAME      float_03
...
/* Input Port  3 */
#define IN_PORT_3_NAME      float_04
...
/* Input Port  4 */
#define IN_PORT_4_NAME      float_05
...
/* Input Port  5 */
#define IN_PORT_5_NAME      float_06
...
/* Input Port  6 */
#define IN_PORT_6_NAME      float_07
...
/* Input Port  7 */
#define IN_PORT_7_NAME      float_08
...
#define NPARAMS              1
/* Parameter  1 */
#define PARAMETER_0_NAME      Address
...
extern void MinSegBus08Float_BT_Outputs_wrapper(const real32_T *float_01,
...
extern void MinSegBus08Float_BT_Update_wrapper(const real32_T *float_01,
			const real32_T *float_02,
			const real32_T *float_03,
			const real32_T *float_04,
			const real32_T *float_05,
...
{
    const real32_T   *float_01  = (const real32_T*) ssGetInputPortSignal(S,0);
    const real32_T   *float_02  = (const real32_T*) ssGetInputPortSignal(S,1);
    const real32_T   *float_03  = (const real32_T*) ssGetInputPortSignal(S,2);
    const real32_T   *float_04  = (const real32_T*) ssGetInputPortSignal(S,3);
    const real32_T   *float_05  = (const real32_T*) ssGetInputPortSignal(S,4);
    const real32_T   *float_06  = (const real32_T*) ssGetInputPortSignal(S,5);
    const real32_T   *float_07  = (const real32_T*) ssGetInputPortSignal(S,6);
    const real32_T   *float_08  = (const real32_T*) ssGetInputPortSignal(S,7);
    const real_T   *xD = ssGetDiscStates(S);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const int8_T  *Address  = (const int8_T *)mxGetData(PARAM_DEF0(S));


    MinSegBus08Float_BT_Outputs_wrapper(float_01, float_02, float_03, float_04, float_05, float_06, float_07, float_08, xD, Address, p_width0);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    MinSegBus08Float_BT_Update_wrapper(float_01, float_02, float_03, float_04, float_05, float_06, float_07, float_08,  xD, Address, p_width0);
}
