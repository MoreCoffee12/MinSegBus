 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Wed Feb 25 18:25:35 2015
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME MinSegBus01Float
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void MinSegBus01Float_Outputs_wrapper(const real32_T *float_01,
			const real_T *xD,
			const int8_T  *Address, const int_T  p_width0);
extern void MinSegBus01Float_Update_wrapper(const real32_T *float_01,
			real_T *xD,
			const int8_T  *Address,  const int_T  p_width0);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    MinSegBus01Float_Outputs_wrapper(float_01, xD, Address, p_width0);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    MinSegBus01Float_Update_wrapper(float_01,  xD, Address, p_width0);
}
